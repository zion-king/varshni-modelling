#Configuration 4: High Perturbation of alpha (α) on V
...
#Import data for Case 4
case4 = pd.read_csv('config4.csv', header = None) 

#Drop missing values
case4.drop([0],inplace = True)
case4.dropna(axis=1,inplace = True) 
# Plot r against initial and modified potentials
r = np.linspace(case4[1].min(),case4[1].max(),300)
spline1 = make_interp_spline(case4[1],case4[2],k=3)
spline2 = make_interp_spline(case4[1],case4[3],k=3)
V1 = spline1(r)
V2 = spline2(r)
plt.plot(r,V1,'b',r,V2,'r-.',linewidth=1.2)
l = plt.legend(['Initial','Perturbed'],loc=1)
