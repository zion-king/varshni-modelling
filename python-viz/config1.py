...
case1=pd.read_csv('config1.csv', header = None)

#Drop missing values
case1.drop([0],inplace = True)
case1.dropna(axis=1,inplace = True) 

# Plot r against initial and modified potentials
r = np.linspace(case1[1].min(),case1[1].max(),300)
spline1 = make_interp_spline(case1[1],case1[2],k=3)
spline2 = make_interp_spline(case1[1],case1[3],k=3)
V1 = spline1(r)
V2 = spline2(r)
